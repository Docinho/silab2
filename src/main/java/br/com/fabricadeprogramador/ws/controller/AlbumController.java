...
public class AlbumController {
	...
	@RequestMapping(method = RequestMethod.POST, value = "/usuarios/{id}/artistas/{idArtista}/albuns", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
